...
## Domain 1 Template: Distributed Runtime Review \[Opus\]
...
## Domain 2 Template: Model Compute & Attention Review \[Opus\]
...
## Domain 3 Template: Inference Backend & Serving Review \[Opus\]
...
## Domain 4 Template: Service Orchestration Review \[Opus\]
...
## Domain 5 Template: Workflow & Trainer Contract Review \[Opus\]
...
## Domain 6 Template: API & Config Compatibility Review \[Sonnet\]
...
## Domain 7 Template: Numerics & Tensor Semantics Review \[Sonnet\]
...
## Domain 8 Template: Checkpoint & Recovery Review \[Opus\]
...
## Domain 9 Template: Launcher & Infrastructure Review \[Sonnet\]
...
## Domain 10 Template: Low-Risk Hygiene Review \[Haiku\]
...
### `agent_service_routing` / `inference_service_dataproxy` Add-On \[Opus\]
